...
\begin{document}
  ...
  \begin{abstract}
    ...
    Heisenberg--Schr\"odinger representation of $\Heis(\Z/q\Z)$ at a fixed non-trivial central
  ...
  \subsection{The question}
    ...
    The admissible fibre $F_n$ carries the Heisenberg--Schr\"odinger representation $\pi_c$
    ...
    The corpus often writes $V_\rho$ for this carrier; nothing below depends on that naming.
  ...
  \subsection{Results and their statuses}
    ...
    \begin{description}
      ...
      \item[Normalisation no-go (Theorem~\ref{thm:nogo}; proved under [H-depth] and the measured
      weight behaviour).]
  ...
  \subsection{Group, sector, and filtration}
    ...
    The Heisenberg--Schr\"odinger representation $\pi_c$ at central character $e^{2\pi i/q}$
    (the corpus convention, $c = 1$) acts
    by
    \[
  ...
  \section{Heisenberg--Schr\"odinger representation: explicit generator actions}
  \label{app:weil}
