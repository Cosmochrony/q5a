...
\begin{document}
  ...
  \begin{abstract}
    On a supplied Heisenberg carrier, the admissible fibre carries the Weil
    representation of $\Heis(\Z/q\Z)$ at a fixed non-trivial central character, and the companion
  ...
  \subsection{The question}
    ...
    The admissible fibre $F_n$ carries the Weil representation $V_\rho$
